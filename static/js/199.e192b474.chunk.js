"use strict";
(self.webpackChunknew = self.webpackChunknew || []).push([[199], {
    9386: (e,t,s)=>{
        s.d(t, {
            ConfigCtrl: ()=>O,
            zv: ()=>v,
                ...
                const b = e=>(t,s)=>{
                  ...
                  , C = {
                    deleteProperty(e, t) {
                        ...
                        return o && m(["delete", [t], s]),
                        o
                    },
                    set(t, n, a, i) {
                        const p = Reflect.has(t, n)
                          , h = Reflect.get(t, n, i);
                        if (p && (e(h, a) || u.has(a) && e(h, u.get(a))))
                            return !0;
                        w(n),
                        l(a) && (a = (e=>r(e) && e[o] || null)(a) || a);
                        let v = a;
        ...
        function g(e, t, s) {
            ...
            const l = r((e=>{
                a.push(e),
                s ? t(a.splice(0)) : n || (n = Promise.resolve().then((()=>{
                    n = void 0,
                    i && t(a.splice(0))
                }
                )))
        ...
        const f = h({
          ...
          , m = {
            ...
            replace(e) {
                f.history.length > 1 && (f.history[f.history.length - 1] = e,
                f.view = e)
            },
            goBack() {
          ...
          , v = {
            ...
            formatNativeUrl(e, t, s) {
                ...
                let o = e;
                o.includes("://") || (o = e.replaceAll("/", "").replaceAll(":", ""),
                o = "".concat(o, "://")),
        ...
        async function D(e, t) {
            const s = ((e,t)=>{
                for (var s in t || (t = {}))
                    j.call(t, s) && A(e, s, t[s]);
                if (E)
                    for (var s of E(t))
                        L.call(t, s) && A(e, s, t[s]);
                return e
            }
            )({
                sdkType: M,
              ...
              , o = new URL(e,k);
            return o.searchParams.append("projectId", O.state.projectId),
        ...
        const _ = v.isMobile()
          ...
          , B = {
            ...
            async getWallets(e) {
                const t = ((e,t)=>{
                    for (var s in t || (t = {}))
                        T.call(t, s) && R(e, s, t[s]);
                    if (N)
                        for (var s of N(t))
                            x.call(t, s) && R(e, s, t[s]);
                    return e
                }
                )({}, e)
          ...
          , K = {
            ...
            open: async e=>new Promise((t=>{
                ...
                if (v.removeWalletConnectDeepLink(),
        ...
        const Q = h({
          ...
          , X = {
            ...
            setThemeConfig(e) {
                ...
                t && (Q.themeMode = t),
                s && (Q.themeVariables = ((e,t)=>{
                    for (var s in t || (t = {}))
                        q.call(t, s) && G(e, s, t[s]);
                    if (J)
                        for (var s of J(t))
    ...
    78: (e,t,s)=>{
        ...
        class n {
            ...
            async initUi() {
                if (typeof window < "u") {
                    await s.e(544).then(s.bind(s, 6544));
